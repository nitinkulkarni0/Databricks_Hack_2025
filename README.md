...
The 'databricks_hack_2025' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] databricks_hack_2025_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/databricks_hack_2025.job.yml). The schedule
...
8. You need to refer to Data_Prep to create the datasets which are in external domain first 
